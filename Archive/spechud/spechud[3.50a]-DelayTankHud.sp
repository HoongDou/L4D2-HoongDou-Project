...
public void OnPluginStart()
{
	...
	// Tankhud Delayshow Var
	cDelayShowTankHud_Time  	= CreateConVar("l4d2_tankhud_delay_time", "0.0", "The time for delay showing tankhud for tank");
	...
	if (FillTankInfo(tankHud, true)) // No tank -- no HUD
	{
		for (int i = 1; i <= MaxClients; ++i)
		{
			...
			if (GetEntProp(i, Prop_Send, "m_zombieClass")!=8)
				...
				{
					CreateTimer(cDelayShowTankHud_Time.FloatValue, DelayShowTankHud);
				}
