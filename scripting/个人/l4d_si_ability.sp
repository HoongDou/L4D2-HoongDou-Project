...
public void OnPluginStart()
{
	...
	cVar = CreateConVar("l4d_si_ability_cooldown_slap", "15.0", "0=Off, >0: Seconds before SI can slap again.", FCVAR_NOTIFY, true, 0.0);
	...
	cVar = CreateConVar("l4d_si_ability_announce", "0", "0=Off, 1=Chat, 2=Center chat, 3=Hint.", FCVAR_NOTIFY, true, 0.0, true, 3.0);
	...
	cVar = CreateConVar("l4d_si_ability_slap", "6", "Special Infected who can slap. Add numbers together: 0=Off, 2=Smoker, 4=Boomer, 8=Hunter, 16=Spitter, 32=Jockey, 64=Charger, 126=All. Default: Boomer|Charger.", FCVAR_NOTIFY, true, 0.0, true, 126.0);
	g_iCvarFlags[Ability_Slap] = cVar.IntValue;
	cVar.AddChangeHook(OnCvarChange_SlapFlags);

	cVar = CreateConVar("l4d_si_ability_shove", "16", "Special Infected who can shove. Add numbers together: 0=Off, 2=Smoker, 4=Boomer, 8=Hunter, 16=Spitter, 32=Jockey, 64=Charger, 126=All. Default: Smoker|Spitter.", FCVAR_NOTIFY, true, 0.0, true, 126.0);
