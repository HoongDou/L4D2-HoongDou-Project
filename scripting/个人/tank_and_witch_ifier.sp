...
public OnPluginStart() {
    g_hCvarDebug = CreateConVar("sm_tank_witch_debug", "0", "Tank and no Witch ifier debug mode", 0, true, 0.0, true, 1.0);
            ...
            for (new iWitchFlow = 0; iWitchFlow <= 100; iWitchFlow++) {
                if (bValidSpawn[iWitchFlow]) {
                    ...
                    if (n == 0) {
                        ...
                        L4D2Direct_SetVSWitchToSpawnThisRound(0, fWitchFlow);
                        L4D2Direct_SetVSWitchToSpawnThisRound(1, fWitchFlow);
                        break;
                    }
                }
            }
