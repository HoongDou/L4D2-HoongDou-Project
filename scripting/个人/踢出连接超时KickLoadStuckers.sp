...
{
	name = "KickLoadStuckers",
	author = "HoongDou",
	description = "踢卡在服务器连接状态的客户端",
...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_kl", KickLoaders, ADMFLAG_KICK, "Kicks everyone Connected but not ingame");
	...
	cvarDuration = CreateConVar("l4d_kickloadstuckers_duration", 	"300", 			" How long before a connected but not ingame player is kicked. (default 60) ", 	0|FCVAR_NOTIFY);
}
