...
/* Globals */
#define UPDATE_URL	"http://anticheat.co/smac/smac_aimbot.txt"
...
/* Plugin Functions */
public AIM_PluginStart()
{
	LoadTranslations("smac.phrases");
	
	// Convars.
	g_hCvarAimbotBan = SMAC_CreateConVar("smac_aimbot_ban", "4", "Number of aimbot detections before a player is banned. Minimum allowed is 4. (0 = Never ban)", FCVAR_PLUGIN, true, 0.0);
